...
- **Next step:** M7 — player controller: third-person camera, walk/run/jump controls, Rapier physics (player character via `CharacterManager`, `player.glb`); keep OrbitControls until player spawns.
