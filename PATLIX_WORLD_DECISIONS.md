...
- **Next step:** M6 — character system: proper rigged agent characters. Needs placeholder Mixamo GLB assets under `apps/patlix-world-web/public/` (decision #7: user downloads GLBs); build a GLB loader + animation controller + shared rig, upgrade `ThreeWorldAdapter` from capsules to characters.
