...
- **Next step:** M8 — AI behavior: state→navmesh→animation for agents (backend already drives status/location; add waypoint travel via events), minimap/waypoint/compass HUD, interaction prompts (`[E] Inspect`).
